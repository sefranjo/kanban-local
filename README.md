...
```
index.html          # Entire application (~1500 lines): HTML + CSS + JS
...
- **Schema**: 3 tables — `columns`, `tasks`, `comments`. Default columns seeded at init: "To Do", "Blocked", "In Progress", "Done".
